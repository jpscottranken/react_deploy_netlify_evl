    ...
    return(
        <div className="row mt-4" id="addStudent">
            ...
            <div className="col-md-2">
                ...
                <input type="text" id="txtGradYear" placeholder="2023" className="form-control" onChange={(evt) => setGradYear(evt.currentTarget.value)} value={gradYear} />
            </div>  

            <div className="col-md-2">
                <button type="button" id="btnAdd" className="btn btn-success btn-lg" onClick={doWork}>Add Student <FontAwesomeIcon icon={faPlusCircle}></FontAwesomeIcon></button>
            </div>
        </div>
    )
}
